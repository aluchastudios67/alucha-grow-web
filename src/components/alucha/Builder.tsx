  ...
  return (
    <section id="builder" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-[1fr_1.2fr] gap-10 items-center">
        <div>
          <span className="text-xs uppercase tracking-[0.25em] text-alucha">{t("builder.badge")}</span>
          ...
          <div className="mt-8 space-y-5">
            <ToggleRow label={t("builder.theme")}>
            ...
            <ToggleRow label={t("builder.layout")}>
            ...
            <ToggleRow label={t("builder.accent")}>
        ...
        <div className="relative">
          ...
          <div className="relative rounded-[2rem] p-3 glass-strong shadow-glow">
            <div className="flex items-center gap-1.5 px-3 py-2">
              ...
              <span className="w-2.5 h-2.5 rounded-full bg-white/20" />
              <span className="w-2.5 h-2.5 rounded-full bg-white/20" />
              <span className="ml-3 text-[11px] text-muted-foreground">{t("builder.previewUrl")}</span>
            </div>
            <div
